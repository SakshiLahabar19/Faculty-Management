...
$query = "SELECT * FROM certification WHERE fname='$fname'";
...
if (isset($_POST['submit'])){
    ...
    $q1 = "DELETE  FROM certification WHERE cername='$cername' and fname='$fname';";
...
<div class="main"> 
    ...
    <form method="post" id="faculty" action="delcerti.php" method="POST">
        <label>Enter  Certificate Name.. </label>
        <br>
