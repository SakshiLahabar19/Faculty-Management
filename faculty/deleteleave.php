...
$sql = "SELECT * FROM `fac_leave` where fname='$fname'"; 
...
//     $cname = $_POST['cname'];
//     $q1 = "DELETE FROM class WHERE cname='$cname' and fname='$fname';";
...
<div class="page-content p-5" id="content">
    ...
    <br><br>
            ...
            <?php echo $row['fname'] ?>
                ...
                <td>
                <a  href="delleave.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">DELETE</a>
                    </td>
