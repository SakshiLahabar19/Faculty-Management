...
$result = mysqli_query($conn,"SELECT * FROM class WHERE fname='$fname'");
...
<br>
<center>
<h1 style="Color:White;">Update Class</h1>
</center>
<br>
<?php
...
<table class="table table-dark">
    ...
    <tr>
        ...
        <td><?php echo $row["cbranch"];   ?></td>
        <td><?php echo $row["cdate"];   ?></td>
        <td><?php echo $row["time"];   ?></td>
        <td><a  href="updateclass.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Update</a></td>
    </tr>
    <?php
    $i++;
    }   
