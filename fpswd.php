            ...
            <div class="row align-items-center">
                <div class="col-md-6 mx-auto py-4 px-0">
                    <div class="card p-0 ">
                        ...
                        <form class="signup" action="verify.php" method="POST">
                            ...
                            <div class="form-group">
                                <label for="freind name">Enter your freinds name</label><br>
                                <br>
                                <input type="text" class="form-control" placeholder="Enter freind name" name="frndname"
                                    id="username" required="true">
                            </div>
                            <br>
                            

                            <button class="btn1 btn-primary" type="submit" name="submit" id="submit">Verify Me</button>
